package com.sk.xjwd.view.waveView;
...
public class DoubleWaveView extends View {
    ...
    public DoubleWaveView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mXOffsetSpeedOne = CommonUtils.dip2px(context, TRANSLATE_X_SPEED_ONE);
        mXOffsetSpeedTwo = CommonUtils.dip2px(context, TRANSLATE_X_SPEED_TWO);
