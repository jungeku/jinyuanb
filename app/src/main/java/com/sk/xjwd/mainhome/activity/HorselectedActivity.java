...
import com.sk.xjwd.view.HorizontalselectedView;

import java.util.ArrayList;
import java.util.List;

public class HorselectedActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_horselected);
        initView();
        initdata();
    }
